...
const apiKey = "0e8fe93d00705914693eeeb20a55f796";
...
async function getWeatherData(cityValue) {
    try {
        ...
        if (!response.ok) {
            throw new Error("Network reaponae was not ok")
        }
        ...
        weatherDataEl.querySelector(".description").textContent = "An error happened,plasee try again later.";
